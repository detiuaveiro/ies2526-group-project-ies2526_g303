...
* Criar o repositório e organizar o workflow Git;
* Priorizar e documentar User Stories iniciais (8–12 histórias);
* Configurar ferramentas de gestão do backlog (GitHub Projects);
* Definir arquitetura base e responsabilidades da equipa.
...
### C. Cenários Suportados (User Stories)
